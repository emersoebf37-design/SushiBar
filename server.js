...
const NOME_CURTO = {
  ...
  "Hot Camarão (8 unidades)"                 : "Hot Camarao x8",
  ...
  "Yakisoba de Frango (M)"                   : "Yaki Frango M",
  "Yakisoba de Frango (G)"                   : "Yaki Frango G",
  "Yakisoba de Calabresa (M)"                : "Yaki Calabresa M",
  "Yakisoba de Calabresa (G)"                : "Yaki Calabresa G",
  "Yakisoba de Carne (M)"                    : "Yaki Carne M",
  "Yakisoba de Carne (G)"                    : "Yaki Carne G",
  "Yakisoba de Legumes (M)"                  : "Yaki Legumes M",
  "Yakisoba de Legumes (G)"                  : "Yaki Legumes G",
  "Yakisoba Misto (M)"                       : "Yaki Misto M",
  "Yakisoba Misto (G)"                       : "Yaki Misto G",
  "Yakisoba de Camarão (M)"                  : "Yaki Camarão M",
  "Yakisoba de Camarão (G)"                  : "Yaki Camarão G",
  "Yakisoba Camarão (M)"                     : "Yaki Camarão M",
  "Yakisoba Camarão (G)"                     : "Yaki Camarão G",
  "Yakisoba de Camarão"                      : "Yaki Camarão",
  "Yakisoba Camarão"                         : "Yaki Camarão",
